...
const { createRider, imageRider, riderLogin, Image, Riderprofile, updateProfile, cancelBookedRide, CompletedRide,
    historyOfBookedRides, ImageStorage, riderImages, riderPassUpdate, createOTP, checkOTP, showRiderToRides,
    selectRide } = require("../Controlers/RiderAction");
...
//this is for uploading the rider image 
router.post("/imageOfRider", imageRider.single("Profile"), Image);
